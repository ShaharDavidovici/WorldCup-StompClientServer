...
public interface Server<T> extends Closeable {
    ...
    public static <T> Server<T>  threadPerClient(
        ...
        return new BaseServer<T>(port, protocolFactory, encoderDecoderFactory, connectim) {
            @Override
    ...
    public static <T> Server<T> reactor(
            ...
            Supplier<MessageEncoderDecoder<T>> encoderDecoderFactory,
            ConnectionsImp<T> connectim) {
        return new Reactor<T>(nthreads, port, protocolFactory, encoderDecoderFactory, connectim);
    }
